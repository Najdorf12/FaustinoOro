  ...
  return (
    <>
      <section className="bg-whiteCustom w-full h-screen pt-16 flex flex-col items-center xl:pt-32 2xl:pt-40">
        <div className="text-zinc-600 text-4xl font-title font-semibold  flex flex-col items-center justify-center gap-6 text-center px-3 text-balance max-w-[700px] xl:max-w-[900px] 2xl:max-w-[1000px]  xl:text-5xl 2xl:text-6xl 2xl:gap-9">
          ¡UPS ...!
