const Stats = () => {
  return (
    ...
    <article className="z-50 flex flex-col justify-center items-center gap-3 lg:gap-5 text-center sm:max-w-[600px] lg:max-w-[800px] xl:-mt-[10%]">
      <h6 className="font-title text-5xl font-bold md:text-6xl lg:text-[10dvh]">LOREM IMPSUM</h6>
      <p className="font-text text-gray-300 text-base md:text-lg lg:text-xl">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quo impedit sit aliquam laborum incidunt consectetur dicta temporibus libero, illum provident nobis, veniam sed! Voluptatem nulla rerum earum dolores alias quibusdam. Voluptatem nulla rerum earum dolores alias quibusdam.</p>
    </article>
    </section>
    </>
  );
