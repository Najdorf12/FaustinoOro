...
import imgFausti6 from "../assets/4.jpeg";
...
const Gallery = () => {
  return (
    <>
      ...
      <section
        id="four_section"
        className="w-full flex justify-center items-start  h-[90dvh] lg:justify-start lg:pl-[5%] lg:h-screen z-50 md:z-10 overflow-y-visible relative px-1 lg:pb-9 xl:pb-9 "
      >
