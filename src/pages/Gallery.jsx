    ...
    <>
      ...
      >
        <article className="h-full relative pt-2 pl-3 sm:px-2  gap-3 z-40 sm:max-w-[400px] md:max-w-[70%] sm:pl-6  md:ml-[3%] lg:ml-[4%]  2xl:pt-0  2xl:mt-16  text-balance">
          <h3 className="mt-1 font-title text-balance  max-w-[350px] text-stone-600 font-bold text-[3.5rem] leading-[1] z-50 lg:text-[5rem] xl:text-[13.5vh] lg:max-w-[1000px]  2xl:max-w-[1200px] 2xl:text-[13vh]">
