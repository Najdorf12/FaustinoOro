...
const Gallery = () => {
  ...
  return (
    <>
      ...
      >
        <article className="h-full relative pt-2 pl-3 sm:px-2  gap-3 z-40 sm:max-w-[600px] md:max-w-[85%] sm:pl-6  md:ml-[3%] lg:ml-[7%] xl:max-w-[90%] 2xl:pt-0 2xl:ml-[9%] 2xl:max-w-[1100px] 2xl:mt-20  text-balance">
          <h3 className="mt-1 font-title text-balance  max-w-[380px] text-stone-600 font-bold text-[7vh] leading-[1] z-50 lg:text-[11vh] lg:max-w-[780px]  2xl:max-w-[950px]">
