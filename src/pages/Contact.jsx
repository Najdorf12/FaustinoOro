...
const Contact = () => {
  ...
  return (
    <>
      <div className="w-full h-[10dvh] lg:h-[20dvh] bg-gray-300 lg:bg-zinc-900  relative">
      ...
      <section className="w-full h-auto  bg-zinc-900 flex flex-col  gap-3 pt-12 xl:pt-[3%]">
        ...
        <div className="flex justify-center items-center gap-2 mb-2 font-title text-sm 2xl:text-base text-amber-600 z-50 xl:mb-1 xl:-mt-3">
