  ...
  return (
    <main className="bg-gray-300 w-full min-h-screen pt-20 relative flex flex-col items-center xl:pt-20 overflow-hidden">
      ...
      <nav className="w-full absolute top-0 right-0 z-50 flex justify-start pl-4 pt-4 xl:justify-start xl:pl-12  xl:pt-6 2xl:pl-14">
        <Link to={"/"}>
          <button className="border-l-[2px] border-white text-white cursor-pointer flex items-center justify-between pl-3 w-[100px] xl:text-xl  2xl:text-2xl">
            Inicio
      ...
      <article className="w-full flex flex-col justify-center items-center z-50">
        ...
        >
          ...
          <p className="font-text2 text-balance mt-3 text-zinc-400  max-w-[350px] lg:max-w-[500px] xl:mt-6 xl:text-lg text-start 2xl:text-xl 2xl:max-w-[600px]">
      ...
      <section className="z-50 w-full flex flex-col justify-start pt-12 pb-20 items-center px-3 mt-20 bg-zinc-800 min-h-screen xl:items-start 2xl:mt-28 xl:pt-20">
        <div className="w-full text-center text-balance flex flex-col gap-3 xl:gap-6">
          ...
          <p className="text-stone-500 font-text2 text-lg w-[370px] md:w-auto md:max-w-[450px] self-center lg:text-xl 2xl:text-2xl 2xl:mt-2">
