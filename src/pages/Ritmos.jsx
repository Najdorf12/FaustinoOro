    ...
    <>
      ...
      >
        <section className="z-50 mt-3 w-full flex flex-col gap-3 items-center justify-center lg:mt-0  lg:w-1/2  lg:items-end">
          ...
          mt-3 ml-2 xl:text-5xl xl:ml-4 sm:px-3 text-balance"
            >
              ¿QUÉ PIENSO DE CADA RITMO?
              <div className="flex items-center mt-3 xl:mt-5">
                <span className="w-[80%] h-[2.5px] bg-zinc-500 -mt-[1px] "></span>
                <i class="bx bx-right-arrow-alt text-3xl -ml-[8px] text-zinc-500 xl:mt-0"></i>
              </div>
            </p>
          </figure>
          <div
          ...
          >
            <section className="w-full flex flex-col justify-center items-center gap-2 z-50  ">
              {icons?.map((icon, i) => (
                <div
                  key={i}
                  className="relative w-full flex items-center justify-start gap-4 pl-2 h-[50px] hover:scale-105 duration-500 rounded-2xl rounded-tl-none rounded-br-3xl border-[2px]  border-zinc-500 bg-gradient-to-br from-bluefausti via-zinc-800 to-transparent xl:h-[65px]"
                >
        ...
        <div className="flex justify-center items-center gap-2 w-full font-text2 xl:gap-3 lg:w-1/2  lg:justify-start lg:mt-6  z-50">
          <article className="w-full py-3 px-3 mt-3 rounded-2xl rounded-tl-none rounded-br-3xl border-[2px] border-stone-400  text-balance  hover:scale-105 duration-500 bg-gradient-to-br from-bluefausti via-zinc-800 to-transparent max-w-[450px] z-50 lg:mt-0 lg:h-full xl:max-w-[500px] xl:py-12 xl:px-6">
            ...
            <p className="text-stone-400 relative w-full text-base  mt-2 xl:text-lg xl:mt-3">
              Es el ritmo más rápido, con partidas que duran entre 1 y 2 minutos
              por jugador. Me encanta este ritmo on-line ya que tengo que jugar
              con una velocidad extrema, siempre al límite del tiempo y me
              divierte. Usualmente participo de torneos on-line como el "Bullet
              Brawl" o "Titled Arena" donde puedo competir con jugadores de la
              Elite, y he tenido oportunidad de ganarle a muchos de ellos en
              este ritmo como a Magnus Carlsen. Me gusta mucho hacer streaming
              mientras juego este tipo de torneos y comentar.
            </p>
          </article>
        </div>
