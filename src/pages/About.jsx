...
const About = () => {
  ...
  return (
    <>
      <section
        id="second_section"
        className="w-full h-screen bg-[#e8e8e8] flex flex-col font-title pt-[20px]"
      >
        <article className="relative pt-24 lg:pt-0 px-3 flex flex-col gap-3 z-50 sm:max-w-[550px] sm:self-end xl:mr-[7%] lg:mt-[4%] 2xl:mr-[12%] 2xl:mt-[6%]  2xl:max-w-[650px]   ">
          <h5 id="about-text" className="text-xl font-title4 text-stone-500 2xl:text-3xl opacity-0">
            About me
          </h5>
          <h3 id="about-text" className="text-black text-3xl 2xl:text-5xl opacity-0">
            ERASING NATIVE APIS LIKE INTERSECTION OBSERVER, CSS STICKY Y NOERS.
          </h3>
          <div id="about-text" className="w-[200px] h-[2px] bg-stone-500 rounded-md my-2"></div>
          <p id="about-text" className="relative mt-2 text-lg font-text2 2xl:text-[1.5rem]  text-gray-400">
          ...
          <div id="about-text" className="mt-3 w-36 h-10 flex justify-center items-center px-5 bg-zinc-700 font-title4 font-medium text-white border-2 border-white md:hidden">
            Button
          </div>
          <div  className="flex gap-8">
            <div id="about-text" class="invisible md:visible scene font-title4 font-medium xl:mt-6">
              <div class="cube">
