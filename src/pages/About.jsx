...
const About = () => {
  ...
  return (
    <>
      ...
      >
        <article className="relative  pt-24 lg:pt-0 px-3 pl-[4%] sm:pl-[6%] lg:pl-0 flex flex-col gap-3 z-50 sm:max-w-[550px] lg:mr-[2%] lg:mt-12 xl:max-w-[650px] xl:mt-16 2xl:mt-20  2xl:mr-[6%]  2xl:max-w-[750px] text-balance ">
          <h5
            id="about-text"
