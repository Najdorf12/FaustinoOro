    ...
    <Link to={"/news/id"}>
      <div className="w-[180px] border-[2px] border-zinc-500 hover:scale-105 duration-500 z-50  rounded-2xl xl:w-[240px]">
        ...
        <article className="pt-3 text-balance rounded-b-2xl flex flex-col bg-gradient-to-tl from-bluefausti via-zinc-800 to-zinc-800 ">
          <h6 className="text-white font-text2 text-center text-base leading-5 xl:text-xl xl:leading-tight">
            FAUSTINO CONSIGUE OTRO HITO HISTORICO
          </h6>
          <div className="w-[95%] h-[1px] self-center bg-zinc-500 mt-2 xl:mt-3"></div>
          <p className="mt-2 text-stone-400 font-title font-normal text-sm px-3 leading-5  xl:text-base xl:leading-tight xl:mt-3">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
          </p>
          <button className="self-end rounded-full h-[35px] w-[35px] mt-1 flex justify-center items-center border-[2px] border-zinc-500 bg-zinc-100 xl:mt-4">
